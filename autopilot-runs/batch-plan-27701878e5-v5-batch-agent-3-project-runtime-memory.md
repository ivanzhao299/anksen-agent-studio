...
- risk: MEDIUM
- task_workspace: autopilot-runs/workspaces/batch-plan-27701878e5/v5-batch-agent-3-project-runtime-memory
...
- autopilot-runs/batch-plan-27701878e5-v5-batch-agent-3-project-runtime-memory.json
- autopilot-runs/batch-plan-27701878e5-v5-batch-agent-3-project-runtime-memory.md
- autopilot-runs/workspaces/batch-plan-27701878e5/v5-batch-agent-3-project-runtime-memory/workspace.json
