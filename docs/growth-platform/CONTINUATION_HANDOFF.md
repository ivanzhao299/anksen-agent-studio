...
5. The sanitized Pilot readiness evidence is projected into the authenticated Growth Console without an activation action. Central Production Ops policy and tenant-scoped, unexpired Business Source Governance approval override their JSON fixture fields; keep tenant isolation and fail-closed API evidence green.
