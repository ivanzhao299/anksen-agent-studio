...
8. Build a read-only activation preflight projection and explicit production-operations handoff; do not expose execution until current-user authorization, approved-record evidence and operational rollback are proven end to end.
