...
if(report.status!=='PILOT_ACTIVATION_BLOCKED'||!report.implementationReady||report.activationReady||!report.blockers.includes('EXPLICIT_PRODUCTION_AUTHORIZATION')||!report.blockers.includes('PRODUCTION_OPERATIONS_POLICY'))throw new Error(`GROWTH_PILOT_READINESS_UNEXPECTED ${JSON.stringify(report)}`);
