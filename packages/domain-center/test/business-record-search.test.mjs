...
test("business search returns only scoped authoritative records with stable pagination",async()=>{
  ...
  await store.createRecord("smart-park-platform",{objectType:"service_order",displayKey:"SRV-SEARCH-1",title:"园区采购报修",fields:{enterpriseName:"测试企业",serviceType:"报修",location:"A座",requestedAt:"2026-07-21T08:00",slaHours:4,priority:"一般",assignedTeam:"设施服务班组",description:"测试"}},finance);
