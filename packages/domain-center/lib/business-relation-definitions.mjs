...
export const businessRelationContracts=Object.freeze([
  ...
  contract("ai-growth-sales-platform","campaign","video_matrix","PRODUCES_MATRIX","Campaign 形成视频内容矩阵",["PLANNING","WAITING_APPROVAL","SCHEDULED","RUNNING"]),
  contract("ai-growth-sales-platform","content_asset","video_matrix","MASTER_OF","已审批内容作为视频矩阵母版",["APPROVED"]),
  ...
  contract("ai-growth-sales-platform","publish_plan","lead","ATTRACTS","已完成发布计划形成合规线索来源",["COMPLETED"]),
  ...
  contract("ai-growth-sales-platform","opportunity","transaction_handoff","HANDS_OFF","赢单商机进入交易系统交接",["WON","HANDED_OFF"]),
  contract("ai-growth-sales-platform","customer","transaction_handoff","PARTY_TO","有效客户绑定交易交接",["ACTIVE"]),
  contract("ai-growth-sales-platform","product","transaction_handoff","SOLD_AS","有效产品绑定交易交接",["ACTIVE"]),
  contract("ai-growth-sales-platform","transaction_handoff","customer_success_case","SERVICED_BY","已交接交易形成客户成功服务",["HANDED_OFF","COMPLETED"]),
  contract("ai-growth-sales-platform","customer","customer_success_case","REQUESTS_SERVICE","有效客户发起售后服务",["ACTIVE"]),
