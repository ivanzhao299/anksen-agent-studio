...
export const enterpriseAcceptanceScenarios = Object.freeze([
  { role:"STRATEGY_OWNER", applicationId:"enterprise-strategy-platform", objectType:"objective", title:"提升集团经营质量", fields:{period:"2027-2029",perspective:"增长",targetValue:18,unit:"%",responsibleCenter:"集团战略中心"}, related:{direction:"OUTGOING",objectType:"kpi",relationType:"MEASURED_BY",title:"经营质量完成率",fields:{period:"2027",baseline:10,targetValue:18,actualValue:12,direction:"越高越好",unit:"%",ownerDepartment:"集团战略中心",actualAsOf:"2026-07-21",actualEvidenceRef:"KPI-EVIDENCE-ACC-001"}} },
  { role:"HR_OPERATOR", applicationId:"human-resources-platform", objectType:"recruitment_case", title:"招聘经营分析负责人", fields:{department:"集团经营中心",positionName:"经营分析负责人",headcount:1,targetDate:"2026-10-01",employmentType:"全职",reason:"补充跨业务分析能力"}, related:{direction:"OUTGOING",objectType:"onboarding_case",relationType:"RESULTS_IN",title:"经营分析负责人入职",fields:{employeeName:"验收候选人",candidateRef:"CAND-ACC-001",department:"集团经营中心",positionName:"经营分析负责人",employmentType:"全职",startDate:"2026-10-01",manager:"经营中心负责人",identityVerificationRef:"IDV-ACC-001",contractDocumentRef:"CONTRACT-ACC-001",equipmentRequestRef:"EQUIP-ACC-001",accessProfileRef:"ACCESS-ACC-001"}} },
  ...
  { role:"MANUFACTURING_PLANNER", applicationId:"intelligent-manufacturing-erp", objectType:"work_order", title:"验收生产工单", fields:{productCode:"ACC-P001",quantity:20,unit:"台",dueDate:"2026-08-31",plant:"验收工厂",priority:"关键"}, related:{direction:"INCOMING",objectType:"bom",relationType:"USED_BY",title:"ACC-P001 产品 BOM",fields:{productCode:"ACC-P001",revision:"A",plant:"验收工厂",effectiveDate:"2026-07-01",componentCount:8,componentRequirements:"ACC-M001:2,ACC-M002:1"}} },
  { role:"PARK_OPERATOR", applicationId:"smart-park-platform", objectType:"service_order", title:"验收园区服务工单", fields:{enterpriseName:"隔离测试企业",serviceType:"报修",location:"A1-101",requestedAt:"2026-07-21T08:00",slaHours:4,priority:"紧急",assignedTeam:"设施服务班组",description:"空调控制器告警"}, related:{direction:"INCOMING",objectType:"enterprise",relationType:"REQUESTS",title:"隔离测试入园企业",fields:{creditCode:"91320000ACCEPTANCE",industry:"智能制造",contactName:"验收联系人",contactPhone:"credential-ref://acceptance/phone",requestedArea:500}} }
]);
