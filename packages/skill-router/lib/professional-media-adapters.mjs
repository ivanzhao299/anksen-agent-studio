...
export const implementedProfessionalAdapterIds=Object.freeze(["hyperframes-artifact-adapter-v1","remotion-artifact-adapter-v1","video-use-artifact-adapter-v1","manim-artifact-adapter-v1","ffmpeg-quality-adapter-v1"]);
