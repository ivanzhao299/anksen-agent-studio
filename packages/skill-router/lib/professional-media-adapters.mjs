...
import { createHyperframesArtifactAdapter } from "./hyperframes-artifact-adapter.mjs";
import { createRemotionArtifactAdapter } from "./remotion-artifact-adapter.mjs";
import { createManimArtifactAdapter } from "./manim-artifact-adapter.mjs";
import { createVideoUseArtifactAdapter } from "./video-use-artifact-adapter.mjs";
import { createBlenderDigitalHumanAdapter } from "./blender-digital-human-adapter.mjs";
import { createKlingAiVideoAdapter } from "./kling-ai-video-adapter.mjs";

export const implementedProfessionalAdapterIds=Object.freeze(["hyperframes-artifact-adapter-v1","remotion-artifact-adapter-v1","video-use-artifact-adapter-v1","manim-artifact-adapter-v1","blender-digital-human-adapter-v1","kling-ai-video-adapter-v1","ffmpeg-quality-adapter-v1"]);
...
export function createProfessionalMediaAdapters({repoRoot=process.cwd(),run=spawnSync}={}){
  ...
  return Object.freeze({
    "media-generative-hyperframes":createHyperframesArtifactAdapter({repoRoot}),
    "media-programmatic-remotion":createRemotionArtifactAdapter({repoRoot}),
    "media-footage-video-use":createVideoUseArtifactAdapter({repoRoot}),
    "media-technical-manim":createManimArtifactAdapter({repoRoot}),
    "media-digital-human-blender":createBlenderDigitalHumanAdapter({repoRoot}),
    "media-ai-video-kling":createKlingAiVideoAdapter({repoRoot}),
