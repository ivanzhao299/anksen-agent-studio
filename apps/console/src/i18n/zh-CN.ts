...
export const zhCN = {
  ...
  common: {
    ...
    notRead: "不读取",
    falseValue: "否",
    noExternalCalls: "无外部调用、无密钥读取、无部署、无生产操作。"
  },
  pages: {
    dashboard: {
      title: "总览",
      ...
      platform: "平台状态",
      activeProject: "当前项目",
      latestAutopilot: "最新自动驾驶记录",
      runtimeProfiles: "运行时配置",
      workers: "Worker 节点",
      credentialRefs: "凭证引用",
      credentialBackends: "凭证后端",
      governanceGates: "治理闸门"
    },
    projects: {
      title: "项目",
    ...
    autopilot: {
      ...
      latestRun: "最新运行",
      executionMode: "执行模式",
      writesFromConsole: "控制台写入",
      latestRunSummary: "最新运行摘要"
    },
    actions: {
      title: "操作中心",
      actions: "操作数量",
...
export type ConsoleZhCNMessages = typeof zhCN;
