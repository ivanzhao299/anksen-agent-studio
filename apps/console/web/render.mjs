...
function pageBusinessApplication(application, data) {
  ...
  const appJson=JSON.stringify(applicationView).replaceAll("<","\\u003c"),canOperate=(data.renderAuth.capabilities??[]).some(value=>value==="*"||value==="business.operate");
